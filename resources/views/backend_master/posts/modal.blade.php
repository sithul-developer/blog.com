...
<div class="modal fade" id="deletetModal">
    <form action="{{ route('prices.delete') }} " method="POST">
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            align-items: center;">
                        <i class="bi bi-exclamation-triangle text-xl text-danger"
                            style="font-size: 2rem; margin-right: 1rem"> </i><p>Are you sure you want to go ?</p>
                        <input type='hidden' name='posts' id='deleteid' />
                    </div>
                </div>

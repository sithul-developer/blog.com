...
@section('content')
    <section>
        ...
        <nav class="pb-2" style="display: flex">
          {{--   @can('role view') --}}
                <a href=" {{ url('/panel/dashboard/category/create') }}">
                            ...
                            <table class="table  table-hover striped ">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($category as $item)
                                        <tr>
                                            <td class="col" id="column">{{ $item->id }}</td>
                                            <td class="col" id="column">{{ $item->name }}</td>
                                            <td class="col" id="column">{{ $item->description }}</td>
                                            <td class="col" id="column">{{ $item->created_at->format('d/M/Y') }}
                                            </td>
                                            ...
                                            <td class="col" id="column" >
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                    ...
                                                    <a
                                                        href="{{ url('/panel/dashboard/category/edit/' . $item->id) }}"><i
                                                    ...
                                                    <a
                                                        href="{{ url('/panel/dashboard/category/view/' . $item->id) }}"><i

                ...
                <div class="card m-0 pt-3">
                    <div class="card-body">
                        <div class="col-12">
                            ...
                            <input type="text" value="{{ $category->name }}" name="category" id="category"
                        ...
                        <div class="col-12 pt-3">
                            <label for="validationCustom04" class="form-label">Description <span
                                    class="text-danger">*</span></label>
                            <textarea value="{{ $category->description }}" name="description" id="description" placeholder="description"
                                class="form-control @error('description') is-invalid @enderror has-validation " style="height: 100px" required> {{ $category->description }}</textarea>

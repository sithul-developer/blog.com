        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-0 pt-3">
                    <div class="card-body">
                        <form class="row g-3 needs-validation" action="{{ url('/panel/dashboard/permission/store') }}"
                            method="POST" novalidate enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="col-12">
                                <label for="yourName" class="form-label">Permision Name <span
                                        class="text-danger ">*</span></label>
                                <input type="text" class="form-control " name="name" value="{{ old('permission') }}"
                                    id="" placeholder="Please input permission">
                            ...
                            <div class="col-lg-12">
                                <label for="yourEmail" class="form-label">Guard_name <span
                                        class="text-danger ">*</span> </label>
                                <input type="text" readonly value="" id="guard_name"
                                    class="form-control   has-validation " placeholder="" required="">
                            </div>

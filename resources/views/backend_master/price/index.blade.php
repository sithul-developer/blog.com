                            ...
                            <table class="table  table-hover striped ">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" id="col">Effect Date Time </th>
                                ...
                                <tbody>
                                    @foreach ($prices as $price)
                                        <tr>
                                            <td class="col" id="column">{{ $price->id }}</td>
                                            ...
                                            <td class="col" id="column">{{ $price->time_effect }}</td>
                                            ...
                                            <td class="col" id="column">{{ $price->created_at->format('d/M/Y') }}
                                            </td>
                                            <td class="col" id="column">
                                                {{ Carbon\Carbon::parse($price->update_at)->format('d/M/Y') }}</td>
                                            <td class="col" id="column">
